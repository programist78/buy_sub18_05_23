      ...
      <div className={styles.description}>
        ...
        <div className={styles.pricebox}>
          <div className={styles.left_child_box}>
            <p className="nav_text">
              Create a post on Instagram with our brand
            </p>
            <p className="text">${data?.postPrice / 100}</p>
          </div>
          <Link
            onClick={() => dispatch(setSelectBus(data?.brandname))}
            href="/personal/poster"
          >
        ...
        <div className={styles.social}>
          ...
          <div className={styles.row_social}>
            ...
            {data?.socialMedia?.twitter?.name !== "" &&
              data?.socialMedia?.twitter !== null && (
                <a
                  href={`https://www.tiktok.com/@${data?.socialMedia?.twitter?.name}/`}
                >
