...
PFD LLC through POSTFORDOLLARS.com provides a platform that connects individuals ("Posters") who create social media posts with businesses ("Clients") that want to promote their products or services. Posters are compensated for their posts(if approved), which become the property of PFD LLC and can be used by the Clients.
<br />
<br />
3. Eligibility
...
<br />
4. User Accounts
To use certain features of our website and be compensated or rebated, you are required to create a valid and eligible user account. You are responsible for maintaining the confidentiality of your account information, including your username and password. You agree to accept responsibility for all activities that occur under your account.
<br />
<br />
5. Compensation and Ownership of Posts
As a Poster, you may be compensated or rebated for the social media posts you create on behalf of Clients. This compensation or rebate is only due upon approval of by the business at their discretion. We at PFD LLC also have full discretion and authority to accept or reject posts. The amount of net compensation is listed on that particular businesses section of the PostForDollars.com website. As a Poster you may only be compensated for posting for each business once per month per social media site and review site unless directed otherwise. Some businesses will only allow one post per Poster in total or some other limit. Compensation or rebate shall be placed in a credit account meaning the approved funds are available for payment to the poster upon request. Credit account shall be deducted $5.00 per month if no activity is on the account for 60 days. Payment shall be paid to poster only from approved provided payment account done via the PostForDollars.com website. Once a post is submitted, it becomes the property of PFD LLC and can be used by the respective Client for promotional purposes. You agree to grant PFD LLC and the Clients a worldwide, royalty-free, non-exclusive, transferable, and sub-licensable right to use, reproduce, modify, adapt, publish, distribute, and display your posts. If compensation or rebate for a calendar year exceeds $550.00 then before any additional approved funds are dispersed from a Poster’s account a w-9 tax form might be requested to be completed and submitted. Posters are not employees of PFD LLC and shall not be construed as such. 
<br />
<br />
...
<br />
<br />
11. Responsibility for Business Listings, Reviews, and Other User-Contributed Content; Participation in Interactive Forums
...
In no event shall PFD LLC, its directors, officers, employees, or agents be liable for any direct, indirect, incidental, special, or consequential damages arising out of or in connection with your use of our website, even if advised of the possibility of such damages.
<br />
<br />
19. Indemnification
You agree to indemnify and hold harmless PDF LLC, its directors, officers, employees, and agents from and against any and all claims, liabilities, damages, losses, costs, and expenses arising out of or in connection with your use of our website or any breach of these Terms and Conditions.
<br />
<br />
20. Modifications
...
These Terms and Conditions shall be governed by and construed in accordance with the laws of the United States. Any disputes arising out of or in connection with these Terms and Conditions shall be subject to the exclusive jurisdiction of the federal and state courts located in [insert location].
<br />
<br />
23. Severability
